...
非离散型: 连续型, 一个或多个区间
  ...
  ## 3.1.1 二维离散型随机变量
  联合概率分布: 通常我们会构造一个分布表, 其中 $P(X=x_i, Y=y_i) = P_{ij}$, $F(x,y)=P(X\leq x, Y\leq y) = \sum_{X_i\leq x} \sum_{Y_i\leq y} P_{ij}$
  <img src="https://github.com/lhcezx/Notes/raw/main/Images/分布表.png" alt="图片无法显示" height=300px>
