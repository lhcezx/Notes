...
非离散型: 连续型, 一个或多个区间
  ...
  2) 指数分布: $f(x) = \begin{cases} \lambda e^{-\lambda x} & if \ x>0 \\\\[3ex] 0 & if \ x\leq 0 \end{cases} $
  ...
  4) 标准正态分布: $\mu = 0, \sigma = 1$. 其密度函数为 $phi(x)_ 0=\frac{1}{\sqrt{2\pi}} e^{-\frac{x^2}{2}}, -\infty<x<+\infty$
  
  分布函数: $\Phi(x)_ 0 =\frac{1}{\sqrt{2\pi}}\int_{-\infty}^{x} e^{-\frac{t^2}{2}}dt$
